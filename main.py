...
def add_config(parser):
    ...
    # model settings
    parser.add_argument('--model_name', type=str, default='STMSDGCN',help=['gwnet','HGCN','STTNS','T_GCN','SANN','DLinear','DKFN','AGCRN'
    ...
    parser.add_argument('--data_name', type=str, default='PEMS04', choices=['PeMS-Bay','METR-LA','PEMS04','PEMS08'])
    ...
    parser.add_argument('--num_gcn', type=int, default=5, help='GCN的层数')
    parser.add_argument('--gcn', type=int, default=1, help='GCN的个数')
    parser.add_argument('--connect', type=str, default='skip', help='[connect, residual, skip]')
