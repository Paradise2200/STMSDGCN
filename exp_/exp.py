...
class EXP():
    ...
    def build_model(self,args,adj):
        if args.model_name == 'gwnet':
        ...
        elif args.model_name == 'STMSDGCN':
            args.heads = 1
            args.patch_len=args.patch_len
            ...
            args.time_of_day_size=args.points_per_hour*24 #一天有几个时间步记录
            args.num_layer=3
            args.num_gcn=args.num_gcn
            self.model = STMSDGCN(num_nodes=args.num_nodes,pred_len=args.pred_len, num_features=args.num_features, supports=adj, args=args)
